...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2019 at 11:15 AM
...
CREATE TABLE `fees_receipt_records` (
  ...
  `bank_status` int(1) NOT NULL DEFAULT '0' COMMENT '1=cleared,0=uncleared',
  `created_at` int(11) DEFAULT NULL,
  `updated_at` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='table records fees receipt';

--
-- Dumping data for table `fees_receipt_records`
--

INSERT INTO `fees_receipt_records` (`fee_receipt_id`, `stud_id`, `user_id`, `receipt_date`, `academic_year`, `sub_total`, `late_fees`, `final_total`, `description`, `mode_of_payment`, `payment_id`, `payed_amount`, `bank_name`, `cheque_no`, `bank_status`, `created_at`, `updated_at`) VALUES
(22, 1, NULL, '2019-02-05 00:00:00', NULL, 5000, 0, 5000, NULL, 1, NULL, 5000, NULL, NULL, 0, 1549355210, 1549355210),
(23, 1, NULL, '2019-02-05 00:00:00', NULL, 5000, 0, 5000, NULL, 1, NULL, 5000, NULL, NULL, 0, 1549355340, 1549355340),
(24, 1, NULL, '2019-02-05 00:00:00', NULL, 10000, 0, 10000, NULL, 2, NULL, 10000, 'SBI', '98898989', 0, 1549358657, 1549358657),
(25, 1, NULL, '2019-02-05 00:00:00', NULL, 5000, 0, 5000, NULL, 1, NULL, 5000, NULL, NULL, 0, 1549361063, 1549361063),
(26, 1, NULL, '2019-02-05 00:00:00', NULL, 15000, 0, 15000, NULL, 1, NULL, 15000, NULL, NULL, 0, 1549361482, 1549361482),
(27, 1, 1, '2019-02-05 00:00:00', NULL, 15000, 0, 15000, NULL, 3, 'MOJO9205R05A82683126', 15000, NULL, NULL, 0, 1549361581, 1549361581);
...
INSERT INTO `paid_fees_records` (`row_id`, `receipt_id`, `stud_id`, `class_id`, `stream_id`, `semester`, `is_tution_fees`, `tution_fees`, `is_extra_fees`, `extra_fees`, `created_at`, `updated_at`) VALUES
(23, '22', '1', '1', 1, 1, 1, 5000, 0, NULL, 1549355210, 1549355210),
(25, '23', '1', '2', 1, 2, 1, 5000, 0, NULL, 1549355340, 1549355340),
(26, '24', '1', '4', 1, 4, 1, 10000, 0, NULL, 1549358657, 1549358657),
(27, '25', '1', '3', 1, 3, 1, 5000, 0, NULL, 1549361063, 1549361063),
(28, '26', '1', '5', 1, 5, 1, 15000, 0, NULL, 1549361482, 1549361482),
(29, '27', '1', '6', 1, 6, 1, 15000, 0, NULL, 1549361581, 1549361581);
...
INSERT INTO `payment_request` (`row_id`, `request_id`, `stud_id`, `class_id`, `stream_id`, `semester`, `is_tution_fees`, `payment_amt`, `is_paid`, `created_at`, `updated_at`) VALUES
(23, '604a67d3c23c406bb3a5b3d0eb38ba6e', 1, 1, 1, 1, 1, 5000, 1, 1549351965, 1549352011),
(24, 'e2246afd5d7341f0818022ed550148f1', 1, 2, 1, 2, 1, 5000, 0, 1549353154, 1549353154),
(25, 'a1b9b66e882845de96dc130d9556a78b', 1, 6, 1, 6, 1, 15000, 1, 1549361550, 1549361581);
...
INSERT INTO `site_settings` (`row_id`, `settings_key`, `settings_value`, `created_at`, `updated_at`) VALUES
(1, 'instamojo_api_key', 'test_b90ebb519779feccd9751fc14da', NULL, NULL),
(2, 'instamojo_api_token', 'test_9d1ffac0ee8f8daf79f014cd5dd', NULL, NULL),
(3, 'instamojo_api_private_salt', '12', NULL, 1549357177);
...
INSERT INTO `student_master` (`stud_id`, `enroll_no`, `stud_name`, `stud_gender`, `stud_dob`, `stud_father_name`, `stud_mobile_no`, `stud_class_id`, `stream_id`, `stud_sem_no`, `created_at`, `updated_at`) VALUES
(1, 1, 'Rushik', 'Male', '2018-02-23', 'Pareshbhai', 9898989898, 1, 1, 2, 1549213217, 1549213217);
...
(2, 'meet@gmail.com', '5295e8150337a53287c2e802162cb04a', 2, 9898989891, NULL, 1549341449, 1549341449);
...
--
ALTER TABLE `fees_receipt_records`
  MODIFY `fee_receipt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
